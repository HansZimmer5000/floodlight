...
public class SetPathResource extends ServerResource {
	...
	public String SetPath(String jsonBody) {
		...
		IACIDUpdaterService updateService = (IACIDUpdaterService) getContext()
				.getAttributes().get(
						IACIDUpdaterService.class.getCanonicalName());
		...
		// For Parameters: String param = (String)
		// getRequestAttributes().get("switch");
